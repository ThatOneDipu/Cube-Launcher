...
pub fn changelog_0_4_1<'a>() -> Element<'a> {
    widget::column![
        widget::text("CubeLauncher is here!").size(40),
        ...
        widget::container(
            widget::column![
                ...
                "- Cube Launcher is Based On Quantum Launcher By Mayman",
        ...
        "- You can control where CubeLauncher stores data by placing a qldir.txt file in one of the following locations:",
        "-- Next to the launcher executable",
        "-- In the working directory where it's run",
        "-- In the global [CubeLauncher folder](https://mrmayman.github.io/quantumlauncher/faq#files-location)",
...
pub fn changelog_0_4<'a>() -> Element<'a> {
    widget::column!(
        widget::text("CubeLauncher Beta").size(40),
...
pub fn changelog_0_3_1<'a>() -> Element<'a> {
    widget::column!(
        widget::text("CubeLauncher Beta").size(32),
        ...
        "- Improved command line support (try cube_launcher --help for more info)",
    ...
    pub fn view<'a>(&'a self, config: &'a LauncherConfig) -> Element<'a> {
        match self {
            MenuWelcome::P1InitialScreen => widget::column![
                ...
                center_x(widget::text("Welcome to CubeLauncher!").size(20)),
...
pub fn welcome_msg<'a>() -> Element<'a> {
    widget::scrollable(widget::column!(
        widget::text("Welcome to CubeLauncher!").size(32),
